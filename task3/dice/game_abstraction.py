...
class GameAbstraction:
    ...
    def determine_first_move(self):
        ...
        inputer = GetInput(self.dices, limit)
    ...
    def start_game(self):
        ...
        if self.user_first:
            ...
            print(f"I make the first move and choose the {self.dices[cp_dice_choice]} dice.")
    ...
    def computer_rolls(self, limit):
        ...
        # Summarize choices
        print(f"My number is {credentials['value']}.")
        print(f"(KEY={credentials['key'].upper()}).")
